...
func encCapabilityObservation(out []byte, v *CapabilityObservation, depth int) []byte {
	out = append(out, '{')
	out = append(out, '\n')
	out = pad(out, depth+1)
	out = esc(out, "request")
	...
	if v.Result != nil {
		...
		out = esc(out, "result")
		out = append(out, ':', ' ')
		out = encResolveResult(out, v.Result, depth+1)
	}
	out = append(out, '\n')
	out = pad(out, depth)
	return append(out, '}')
...
func encRuntimeObservation(out []byte, v *RuntimeObservation, depth int) []byte {
	out = append(out, '{')
	out = append(out, '\n')
	out = pad(out, depth+1)
	out = esc(out, "bootstrap")
	out = append(out, ':', ' ')
	out = encBootstrapObservation(out, &v.Bootstrap, depth+1)
	out = append(out, ',')
	out = append(out, '\n')
	out = pad(out, depth+1)
	out = esc(out, "capabilities")
	out = append(out, ':', ' ')
	out = encList(out, v.Capabilities, depth+1, encCapabilityObservation)
	out = append(out, '\n')
	out = pad(out, depth)
	return append(out, '}')
}
...
func (r *reader) decodeBootstrapObservation() (*BootstrapObservation, error) {
	if r.at() != '{' {
		return nil, r.refuse("wrong_type")
	}
	if err := r.enter(); err != nil {
...
func (r *reader) decodeCapabilityObservation() (*CapabilityObservation, error) {
	if r.at() != '{' {
		return nil, r.refuse("wrong_type")
	}
	if err := r.enter(); err != nil {
...
func (r *reader) decodeRuntimeObservation() (*RuntimeObservation, error) {
	if r.at() != '{' {
		return nil, r.refuse("wrong_type")
	}
	if err := r.enter(); err != nil {
	...
	if r.at() != '}' {
		for {
			...
			case "bootstrap":
				...
				seen |= 1
				x, err := r.decodeBootstrapObservation()
				if err != nil {
					return nil, err
				}
				v.Bootstrap = *x
			case "capabilities":
				...
				seen |= 2
				x, err := decodeList(r, (*reader).decodeCapabilityObservation)
				if err != nil {
					return nil, err
				}
				v.Capabilities = x
